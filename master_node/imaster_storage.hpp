...
public:
    virtual void addNode(std::string strIp, Report::hardware_result hardware, bool monitored = true) = 0;
    ...
    virtual void addReport(Report::report_result result, bool monitored = true) = 0;
    ...
    virtual void addReport(std::vector<Report::report_result> results) = 0;
