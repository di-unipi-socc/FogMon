...
//sudo docker run -it --net=host server --time-report 30 --time-tests 60 --time-latency 100 --time-bandwidth 600 --heartbeat 60 
//sudo docker run -it --net=host server -C 54.93.78.224 --time-report 30 --time-tests 60 --time-latency 100 --time-bandwidth 600 --heartbeat 60 
//sudo docker run -it --net=host node -C 54.93.78.224 --time-report 30 --time-tests 60 --time-latency 100 --time-bandwidth 600 --heartbeat 60 
