...
public:
    virtual ILeaderConnections* getConnections() override = 0;
    virtual ILeaderStorage* getStorage() override = 0;
    ...
    virtual void changeRoles(Message::leader_update update) = 0; // not override
